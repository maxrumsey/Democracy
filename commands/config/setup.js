module.exports = async (msg, command, args, config) => {
  ...
  // Rules Channel
  msg.input("What channel do you want rules to appear in?");
  ...
  // Voting Channel
  msg.input("What channel do you want the votes to appear in?");
  ...
  return msg.success('Done! Now run `d!help` for a list of commands or d!setConfig to change other config values.')
}
